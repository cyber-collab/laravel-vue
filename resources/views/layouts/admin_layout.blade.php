           ...
           with font-awesome or any other icon font library -->
                                ...
                                <li class="nav-item">
                                    <div class="add-button">
                                        <button type="button" name="create_record" id="create_record"
                                            class="btn btn-success"> <i class="bi bi-plus-square"></i>Add new
                                            Employee</button>
                                    </div>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <div align="right">
                                        <button type="button" name="create_position_record" id="create_position_record"
